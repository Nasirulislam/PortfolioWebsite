...
import { afterSprite } from "./afterSprite";
 ...
 */
export const afterGif = async (gif, maxWidth, maxHeight, maxDuration) => {
    const { error, dataUrl, delay, frameWidth, framesLength } = await afterSprite(
        gif,
        maxWidth,
        maxHeight,
        maxDuration
